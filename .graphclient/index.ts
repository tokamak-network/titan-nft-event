...
import type { TitanNftTypes } from './sources/titan-nft/types';
import * as importedModule$0 from "./sources/titan-nft/introspectionSchema";
...
export type MeshContext = TitanNftTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/titan-nft/introspectionSchema":
...
const titanNftHandler = new GraphqlHandler({
              ...
              cache,
              pubsub,
              store: sourcesStore.child("titan-nft"),
              logger: logger.child("titan-nft"),
              importFn,
            });
sources[0] = {
          name: 'titan-nft',
          handler: titanNftHandler,
          transforms: titanNftTransforms
        }
